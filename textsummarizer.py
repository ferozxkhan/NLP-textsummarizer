...
def main():
    st.title("Text Summarization Using Python")
    activities = ["Summarize Via Text"]
    choice = st.sidebar.selectbox("Select Activity", activities)

    if choice == 'Summarize Via Text':
        st.subheader("Summarizing using Natural Language Processing (NLP)")
        ...
        summary_choice = st.selectbox("Choose from existing Python Libraries" , ["NLTK","SPACY"])
